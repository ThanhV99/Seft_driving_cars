...
- Giả sử đường là 1 màu (ở đây đường là các tờ A4 có màu trắng), sử dụng hàm inRange để tách màu của đường, thu được ảnh nhị phân
...
- Tách đường từ ảnh gốc để xử lý
